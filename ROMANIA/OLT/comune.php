...
createComuna("Bărăștii de Vede", [
    ...
    createLoc("Mereni", "sat"),
    createLoc("Moțoești", "sat"),
...
createComuna("Bobicești", [
    ...
    createLoc("Chintești", "sat"),
    createLoc("Comănești", "sat"),
    createLoc("Govora", "sat"),
    createLoc("Leotești", "sat"),
    createLoc("Mirila", "sat")
]),
...
createComuna("Colonești", [
    ...
    createLoc("Chelbești", "sat"),
    createLoc("Cârstani", "sat"),
    createLoc("Guești", "sat"),
    createLoc("Mărunței", "sat"),
    createLoc("Năvârgeni", "sat"),
    createLoc("Vlaici", "sat")
]),
...
createComuna("Curtișoara", [
    ...
    createLoc("Proaspeți", "sat"),
    createLoc("Raițiu", "sat")
]),
...
createComuna("Cungrea", [
    ...
    createLoc("Miești", "sat"),
    createLoc("Oteștii de Jos", "sat"),
    createLoc("Oteștii de Sus", "sat"),
...
createComuna("Leleasca", [
    ...
    createLoc("Mierlicești", "sat"),
    createLoc("Tonești", "sat"),
    createLoc("Tufaru", "sat"),
    createLoc("Urși", "sat")
]),
...
createComuna("Obârșia", [
    ...
    createLoc("Obârșia Nouă", "sat"),
    createLoc("Tabonu", "sat")
]),
...
createComuna("Pleșoiu", [
    ...
    createLoc("Cocorăști", "sat"),
    createLoc("Doba", "sat"),
    createLoc("Schitu din Deal", "sat"),
    createLoc("Schitu din Vale", "sat")
]),
...
createComuna("Sâmburești", [
    ...
    createLoc("Lăunele", "sat"),
    createLoc("Mănulești", "sat"),
    createLoc("Stănuleasa", "sat"),
    createLoc("Tonești", "sat")
]),
...
createComuna("Spineni", [
    ...
    createLoc("Optășani", "sat"),
    createLoc("Profa", "sat"),
    createLoc("Spineni", "sat"),
    createLoc("Vineți", "sat")
]),
...
createComuna("Strejești", [
    ...
    createLoc("Strejeștii de Sus", "sat")
]),
// Studina
...
createComuna("Teslui", [
    ...
    createLoc("Comănița", "sat"),
    createLoc("Corbu", "sat"),
    createLoc("Deleni", "sat"),
    createLoc("Schitu Deleni", "sat")
]),
...
createComuna("Verguleasa", [
    ...
    createLoc("Poganu", "sat"),
    createLoc("Valea Fetei", "sat"),
    createLoc("Vânești", "sat")
]),
...
createComuna("Vitomirești", [
    ...
    createLoc("Donești", "sat"),
    createLoc("Stănuleasa", "sat"),
    createLoc("Trepteni", "sat")
]),
...
createComuna("Voineasa", [
    ...
    createLoc("Rusăneștii de Sus", "sat")
]),
...
createComuna("Vulpeni", [
    ...
    createLoc("Mardale", "sat"),
    createLoc("Pescărești", "sat"),
    createLoc("Plopșorelu", "sat"),
    createLoc("Prisaca", "sat"),
    createLoc("Simniceni", "sat"),
    createLoc("Tabaci", "sat"),
    createLoc("Valea Satului", "sat")
]),
