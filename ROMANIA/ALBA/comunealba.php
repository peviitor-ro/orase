...
$comune =[
			...
			createComuna("Sălciua", [
					createLoc("Sălciua de Jos", "sat"),	
					createLoc("Dealu Caselor", "sat"),	
					createLoc("Dumești", "sat"),
					createLoc("Sălciua de Sus", "sat"),	
					createLoc("Sub Piatră", "sat"),	
					createLoc("Valea Largă", "sat"),					
								  ]),
			createComuna("Săliștea", [
					createLoc("Săliștea", "sat"),	
					createLoc("Mărgineni", "sat"),	
					createLoc("Săliștea-Deal", "sat"),
					createLoc("Tărtăria", "sat"),					
								  ]),
			createComuna("Săsciori", [
					...
					createLoc("Loman", "sat"),	
					createLoc("Pleși", "sat"),	
					createLoc("Răchita", "sat"),
					createLoc("Sebeșel", "sat"),	
					createLoc("Tonea", "sat"),						
								  ]),	
			createComuna("Scărișoara", [
					...
					createLoc("Fața-Lăzești", "sat"),
					createLoc("Florești", "sat"),	
					createLoc("Lăzești", "sat"),	
					createLoc("Lespezea", "sat"),
					createLoc("Maței", "sat"),	
					createLoc("Negești", "sat"),	
					createLoc("Prelucă", "sat"),	
					createLoc("Runc", "sat"),	
					createLoc("Sfoartea", "sat"),
					createLoc("Știuleți", "sat"),
					createLoc("Trâncești", "sat"),						
								  ]),
			createComuna("Sâncel", [
					createLoc("Sâncel", "sat"),	
					createLoc("Iclod", "sat"),	
					createLoc("Pănade", "sat"),					
								  ]),	
			createComuna("Sântimbru", [
					createLoc("Sântimbru", "sat"),	
					createLoc("Coșlariu", "sat"),	
					createLoc("Dumitra", "sat"),
					createLoc("Galtiu", "sat"),	
					createLoc("Totoi", "sat"),					
								  ]),	
			createComuna("Sohodol", [
					createLoc("Sohodol", "sat"),	
					createLoc("Băzești", "sat"),	
					createLoc("Bilănești", "sat"),
					createLoc("Bobărești", "sat"),	
					createLoc("Brădeana", "sat"),	
					createLoc("Burzonești", "sat"),	
					createLoc("Deoncești", "sat"),	
					createLoc("Dilimani", "sat"),
					createLoc("Furduiești", "sat"),	
					createLoc("Gura Sohodol", "sat"),
					createLoc("Hoancă", "sat"),	
					createLoc("Joldișești", "sat"),	
					createLoc("Lazuri", "sat"),
					createLoc("Lehești", "sat"),	
					createLoc("Luminești", "sat"),	
					createLoc("Medrești", "sat"),	
					createLoc("Morărești", "sat"),	
					createLoc("Munești", "sat"),
					createLoc("Năpăiești", "sat"),	
					createLoc("Nelegești", "sat"),	
					createLoc("Nicorești", "sat"),	
					createLoc("Peleș", "sat"),	
					createLoc("Poiana", "sat"),
					createLoc("Robești", "sat"),	
					createLoc("Sicoiești", "sat"),	
					createLoc("Surdești", "sat"),	
					createLoc("Sebișești", "sat"),	
					createLoc("Șimocești", "sat"),
					createLoc("Țoci", "sat"),	
					createLoc("Valea Verde", "sat"),
					createLoc("Vlădoșești", "sat"),						
								  ]),	
			createComuna("Stremț", [
					createLoc("Stremț", "sat"),	
					createLoc("Fața Pietrii", "sat"),	
					createLoc("Geoagiu de Sus", "sat"),
					createLoc("Geomal", "sat"),						
								  ]),	
			createComuna("Șibot", [
					createLoc("Șibot", "sat"),	
					createLoc("Balomiru de Câmp", "sat"),	
					createLoc("Băcăinți", "sat"),
					createLoc("Sărăcsău", "sat"),						
								  ]),	
			createComuna("Șona", [
					createLoc("Șona", "sat"),	
					createLoc("Alecuș", "sat"),	
					createLoc("Biia", "sat"),
					createLoc("Doptău", "sat"),		
					createLoc("Lunca Târnavei", "sat"),	
			...
			createComuna("Șugag", [
					...
					createLoc("Dobra", "sat"),		
					createLoc("Jidoștina", "sat"),	
					createLoc("Mărtinie", "sat"),	
					createLoc("Tău Bistra", "sat"),			
								  ]),	
			createComuna("Unirea", [
					createLoc("Unirea", "sat"),	
					createLoc("Ciugudu de Jos", "sat"),	
					createLoc("Ciugudu de Sus", "sat"),
					createLoc("Dumbrava", "sat"),		
					createLoc("Inoc", "sat"),	
					createLoc("Măhăceni", "sat"),			
								  ]),
			createComuna("Vadu Moților", [
					createLoc("Vadu Moților", "sat"),	
					createLoc("Bodești", "sat"),	
					createLoc("Burzești", "sat"),
					createLoc("Dealu Frumos", "sat"),		
					createLoc("Lăzești", "sat"),	
					createLoc("Necșești", "sat"),	
					createLoc("Poduri-Bricești", "sat"),	
					createLoc("Popeștii de Jos", "sat"),	
					createLoc("Popeștii de Sus", "sat"),
					createLoc("Tomuțești", "sat"),		
					createLoc("Toțești", "sat"),	
					createLoc("Vâltori", "sat"),						
								  ]),
			createComuna("Valea Lungă", [
					createLoc("Valea Lungă", "sat"),	
					createLoc("Făget", "sat"),	
					createLoc("Glogoveț", "sat"),
					createLoc("Lodroman", "sat"),		
					createLoc("Lunca", "sat"),	
					createLoc("Tăuni", "sat"),						
								  ]),
			createComuna("Vidra", [
					...
					createLoc("Bobărești", "sat"),
					createLoc("Bogdănești", "sat"),		
					createLoc("Bordeștii Poieni", "sat"),	
					createLoc("Culdești", "sat"),	
					createLoc("Dealu Goiești", "sat"),	
					createLoc("Dos", "sat"),	
					createLoc("Dosu Luncii", "sat"),	
					createLoc("Dosu Văsești", "sat"),	
					createLoc("Drăgoiești-Luncă", "sat"),
					createLoc("Ficărești", "sat"),	
					createLoc("Gligorești", "sat"),	
					createLoc("Goiești", "sat"),	
					createLoc("Haiducești", "sat"),	
					createLoc("Hărăști", "sat"),
					createLoc("Hoancă", "sat"),	
					createLoc("Jeflești", "sat"),	
					createLoc("Lunca", "sat"),	
					createLoc("Lunca Bisericii", "sat"),	
					createLoc("Lunca de Jos", "sat"),
					createLoc("Lunca Goiești", "sat"),	
					createLoc("Lunca Vesești", "sat"),	
					createLoc("Modolești", "sat"),	
					createLoc("Nemeși", "sat"),	
					createLoc("Oidești", "sat"),
					createLoc("Pitărcești", "sat"),	
					createLoc("Pleșcuța", "sat"),	
					createLoc("Poieni", "sat"),	
					createLoc("Ponorel", "sat"),	
					createLoc("Puiulețești", "sat"),
					createLoc("Runc", "sat"),	
					createLoc("Segaj", "sat"),	
					createLoc("Urdeș", "sat"),	
					createLoc("Valea Morii", "sat"),	
					createLoc("Văsești", "sat"),
					createLoc("Vâlcăneasa", "sat"),	
			...
			createComuna("Vințu de Jos", [
					...
					createLoc("Dealu Ferului", "sat"),	
					createLoc("Gura Cuțului", "sat"),	
					createLoc("Hațegana", "sat"),	
					createLoc("Inuri", "sat"),	
					createLoc("Laz", "sat"),	
					createLoc("Mătăcina", "sat"),	
					createLoc("Mereteu", "sat"),
					createLoc("Pârău lui Mihai", "sat"),	
					createLoc("Poienița", "sat"),	
					createLoc("Stăuini", "sat"),	
					createLoc("Valea Goblii", "sat"),	
					createLoc("Valea lui Mihai", "sat"),
					createLoc("Valea Vințului", "sat"),	
