...
createComuna("Alexandru cel Bun", [
    ...
    createLoc("Scăricica", "sat"),
    createLoc("Vaduri", "sat"),
...
createComuna("Bahna", [
    ...
    createLoc("Liliac", "sat"),
    createLoc("Țuțcanii din Deal", "sat"),
    createLoc("Țuțcanii din Vale", "sat")
]),
...
createComuna("Bârgăuani", [
    ...
    createLoc("Certieni", "sat"),
    createLoc("Chilia", "sat"),
    createLoc("Dârloaia", "sat"),
    createLoc("Ghelăiești", "sat"),
    createLoc("Hârtop", "sat"),
    createLoc("Homiceni", "sat"),
    createLoc("Talpa", "sat"),
    createLoc("Vlădiceni", "sat")
]),
...
createComuna("Borca", [
    ...
    createLoc("Lunca", "sat"),
    createLoc("Mădei", "sat"),
    createLoc("Pârâul Cârjei", "sat"),
    createLoc("Pârâul Pântei", "sat"),
    createLoc("Sabasa", "sat"),
    createLoc("Soci", "sat")
]),
...
createComuna("Borlești", [
    ...
    createLoc("Ruseni", "sat"),
    createLoc("Șovoaia", "sat")
]),
...
createComuna("Crăcăoani", [
    ...
    createLoc("Mitocu Bălan", "sat"),
    createLoc("Poiana Crăcăoani", "sat")
]),
// Dămuc
createComuna("Dămuc", [
				createAdresaCompleta("NEAMT", "NEAMT"),
...
createComuna("Icușești", [
    ...
    createLoc("Rocna", "sat"),
    createLoc("Spiridonești", "sat"),
    createLoc("Tabăra", "sat")
]),
// Ion Creangă
...
createComuna("Oniceni", [
    ...
    createLoc("Gorun", "sat"),
    createLoc("Linsești", "sat"),
    createLoc("Lunca", "sat"),
    createLoc("Mărmureni", "sat"),
    createLoc("Pietrosu", "sat"),
    createLoc("Poiana Humei", "sat"),
    createLoc("Pustieta", "sat"),
    createLoc("Solca", "sat"),
    createLoc("Valea Enei", "sat")
]),
...
createComuna("Pâncești", [
    ...
    createLoc("Holm", "sat"),
    createLoc("Tălpălăi", "sat"),
    createLoc("Patricheni", "sat")
]),
...
createComuna("Pipirig", [
    ...
    createLoc("Leghin", "sat"),
    createLoc("Pâțâligeni", "sat"),
    createLoc("Pluton", "sat"),
...
createComuna("Poiana Teiului", [
    ...
    createLoc("Galu", "sat"),
    createLoc("Petru Vodă", "sat"),
    createLoc("Pârâul Fagului", "sat"),
    createLoc("Poiana Largului", "sat"),
    createLoc("Roșeni", "sat"),
    createLoc("Ruseni", "sat"),
    createLoc("Săvinești", "sat"),
    createLoc("Topoliceni", "sat")
]),
...
createComuna("Secuieni", [
    ...
    createLoc("Bogzești", "sat"),
    createLoc("Butnărești", "sat"),
    createLoc("Giulești", "sat"),
    createLoc("Prăjești", "sat"),
    createLoc("Secuienii Noi", "sat"),
...
createComuna("Stănița", [
    ...
    createLoc("Poienile Oancei", "sat"),
    createLoc("Todireni", "sat"),
    createLoc("Veja", "sat"),
    createLoc("Vlădnicele", "sat")
]),
...
createComuna("Tarcău", [
    ...
    createLoc("Cazaci", "sat"),
    createLoc("Schitu Tarcău", "sat"),
