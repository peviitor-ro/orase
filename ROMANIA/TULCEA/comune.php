...
$comune = [
    ...
    createComuna("Baia", [
        ...
        createLoc("Ceamurlia de Sus", "sat"),
        createLoc("Panduru", "sat")
    ]),
    ...
    createComuna("C.A. Rosetti", [
        ...
        createLoc("Letea", "sat"),
        createLoc("Periprava", "sat"),
        createLoc("Sfiștofca", "sat")
    ]),
    ...
    createComuna("Casimcea", [
        ...
        createLoc("Haidar", "sat"),
        createLoc("Rahman", "sat"),
    ...
    createComuna("Dorobanțu", [
        ...
        createLoc("Fântâna Oilor", "sat"),
        createLoc("Meșteru", "sat")
    ]),
    ...
    createComuna("Murighiol", [
        ...
        createLoc("Dunavățu de Sus", "sat"),
        createLoc("Plopul", "sat"),
        createLoc("Sarinasuf", "sat"),
        createLoc("Uzlina", "sat")
    ]),
    ...
    createComuna("Topolog", [
        ...
        createLoc("Calfa", "sat"),
        createLoc("Cerbu", "sat"),
        createLoc("Făgărașu Nou", "sat"),
        createLoc("Luminița", "sat"),
        createLoc("Măgurele", "sat"),
        createLoc("Sâmbăta Nouă", "sat")
    ]),
