...
$comune =[
	...
	createComuna("Acățari", [
        ...
        createLoc("Gruișor", "sat"),
        createLoc("Murgești", "sat"),
        createLoc("Roteni", "sat"),
        createLoc("Stejeriș", "sat"),
        createLoc("Suveica", "sat"),
    ...
    createComuna("Adămuș", [
        ...
        createLoc("Dâmbău", "sat"),
        createLoc("Herepea", "sat")
    ]),
    ...
    createComuna("Albești", [
        ...
        createLoc("Boiu", "sat"),
        createLoc("Jacu", "sat"),
        createLoc("Șapartoc", "sat"),
        createLoc("Țopa", "sat"),
        createLoc("Valea Albeștiului", "sat"),
        createLoc("Valea Dăii", "sat"),
        createLoc("Valea Șapartocului", "sat")
    ]),
    ...
    createComuna("Ațintiș", [
        ...
        createLoc("Iștihaza", "sat"),
        createLoc("Maldaoci", "sat"),
        createLoc("Sâniacob", "sat")
    ]),
    ...
    createComuna("Bahnea", [
        ...
        createLoc("Daia", "sat"),
        createLoc("Gogan", "sat"),
        createLoc("Idiciu", "sat"),
        createLoc("Lepindea", "sat")
    ]),
    ...
    createComuna("Band", [
        ...
        createLoc("Iștan-Tău", "sat"),
        createLoc("Mărășești", "sat"),
        createLoc("Negrenii de Câmpie", "sat"),
        createLoc("Oroiu", "sat"),
        createLoc("Petea", "sat"),
        createLoc("Țiptelnic", "sat"),
        createLoc("Valea Mare", "sat"),
        createLoc("Valea Rece", "sat")
    ]),
    ...
    createComuna("Bălăușeri", [
        ...
        createLoc("Dumitreni", "sat"),
        createLoc("Filitelnic", "sat"),
        createLoc("Senereuș", "sat")
    ]),
    ...
    createComuna("Beica de Jos", [
        ...
        createLoc("Nadășa", "sat"),
        createLoc("Sânmihai de Pădure", "sat"),
        createLoc("Șerbeni", "sat")
    ]),
    ...
    createComuna("Bereni", [
        ...
        createLoc("Bâra", "sat"),
        createLoc("Cându", "sat"),
        createLoc("Drojdii", "sat"),
        createLoc("Eremieni", "sat"),
        createLoc("Maia", "sat"),
        createLoc("Mărculeni", "sat")
    ]),
    ...
    createComuna("Brâncovenești", [
        ...
        createLoc("Săcalu de Pădure", "sat"),
        createLoc("Vălenii de Mureș", "sat")
    ]),
    ...
    createComuna("Ceuașu de Câmpie", [
        ...
        createLoc("Culpiu", "sat"),
        createLoc("Herghelia", "sat"),
        createLoc("Porumbeni", "sat"),
        createLoc("Săbed", "sat"),
        createLoc("Voiniceni", "sat")
    ]),
    ...
    createComuna("Chețani", [
        ...
        createLoc("Giurgiș", "sat"),
        createLoc("Grindeni", "sat"),
        createLoc("Hădăreni", "sat"),
        createLoc("Linț", "sat")
    ]),
    createComuna("Chibed", [
				createAdresaCompleta("MURES", "MURES"),
    ...
    createComuna("Cozma", [
        ...
        createLoc("Valea Sasului", "sat"),
        createLoc("Valea Ungurului", "sat")
    ]),
    ...
    createComuna("Crăiești", [
        ...
        createLoc("Nima Milășelului", "sat")
    ]),
    ...
    createComuna("Eremitu", [
        ...
        createLoc("Dămieni", "sat"),
        createLoc("Mătrici", "sat")
    ]),
    ...
    createComuna("Ernei", [
        ...
        createLoc("Icland", "sat"),
        createLoc("Săcăreni", "sat"),
        createLoc("Sângeru de Pădure", "sat")
    ]),
    ...
    createComuna("Gălești", [
        ...
        createLoc("Bedeni", "sat"),
        createLoc("Maiad", "sat"),
        createLoc("Sânvăsii", "sat"),
        createLoc("Troița", "sat")
    ]),
    ...
    createComuna("Glodeni", [
        ...
        createLoc("Moișa", "sat"),
        createLoc("Păcureni", "sat"),
        createLoc("Păingeni", "sat")
    ]),
    ...
    createComuna("Gornești", [
        ...
        createLoc("Mura Mare", "sat"),
        createLoc("Mura Mică", "sat"),
        createLoc("Pădureni", "sat"),
        createLoc("Periș", "sat"),
        createLoc("Petrilaca de Mureș", "sat"),
    ...
    createComuna("Gurghiu", [
        ...
        createLoc("Cașva", "sat"),
        createLoc("Comori", "sat"),
        createLoc("Fundoaia", "sat"),
        createLoc("Glăjărie", "sat"),
        createLoc("Larga", "sat"),
        createLoc("Orșova", "sat"),
        createLoc("Orșova-Pădure", "sat"),
        createLoc("Păuloaia", "sat")
    ]),
    ...
    createComuna("Hodac", [
        ...
        createLoc("Dubiștea de Pădure", "sat"),
        createLoc("Mirigioaia", "sat"),
        createLoc("Toaca", "sat"),
        createLoc("Uricea", "sat")
    ]),
    ...
    createComuna("Ibănești", [
        ...
        createLoc("Dulcea", "sat"),
        createLoc("Ibănești-Pădure", "sat"),
        createLoc("Lăpușna", "sat"),
        createLoc("Pârâu Mare", "sat"),
        createLoc("Tireu", "sat"),
        createLoc("Tisieu", "sat"),
        createLoc("Zimți", "sat")
    ]),
    ...
    createComuna("Iclănzel", [
        ...
        createLoc("După Deal", "sat"),
        createLoc("Fânațe", "sat"),
        createLoc("Fânațele Căpușului", "sat"),
        createLoc("Ghidașteu", "sat"),
        createLoc("Iclandu Mare", "sat"),
        createLoc("Mădărășeni", "sat"),
        createLoc("Tăblășeni", "sat"),
        createLoc("Valea Iclandului", "sat")
    ]),
    ...
    createComuna("Mica", [
        ...
        createLoc("Ceuaș", "sat"),
        createLoc("Deaj", "sat"),
        createLoc("Hărănglab", "sat"),
        createLoc("Șomoștelnic", "sat")
    ]),
    ...
    createComuna("Miheșu de Câmpie", [
        ...
        createLoc("Groapa Rădăii", "sat"),
        createLoc("Mogoaia", "sat"),
        createLoc("Răzoare", "sat"),
        createLoc("Șăulița", "sat"),
    ...
    createComuna("Ogra", [
        ...
        createLoc("Lăscud", "sat"),
        createLoc("Vaideiu", "sat")
    ]),
    ...
    createComuna("Pănet", [
        ...
        createLoc("Hărțău", "sat"),
        createLoc("Sântioana de Mureș", "sat")
    ]),
    ...
    createComuna("Pogăceaua", [
        ...
        createLoc("Deleni", "sat"),
        createLoc("Fântâna Babii", "sat"),
        createLoc("Pârâu Crucii", "sat"),
        createLoc("Scurta", "sat"),
        createLoc("Sicele", "sat"),
        createLoc("Valea Sânpetrului", "sat"),
    ...
    createComuna("Râciu", [
        ...
        createLoc("Cotorinau", "sat"),
        createLoc("Curețe", "sat"),
        createLoc("Hagău", "sat"),
        createLoc("Leniș", "sat"),
        createLoc("Nima Râciului", "sat"),
        createLoc("Obârșie", "sat"),
        createLoc("Pârâu Crucii", "sat"),
        createLoc("Sânmărtinu de Câmpie", "sat"),
        createLoc("Ulieș", "sat"),
        createLoc("Valea Seacă", "sat"),
        createLoc("Valea Sânmărtinului", "sat"),
        createLoc("Valea Ulieșului", "sat")
    ]),
    ...
    createComuna("Sânpaul", [
        ...
        createLoc("Valea Izvoarelor", "sat")
    ]),
    ...
    createComuna("Sânpetru de Câmpie", [
        ...
        createLoc("Dâmbu", "sat"),
        createLoc("Satu Nou", "sat"),
        createLoc("Sângeorgiu de Câmpie", "sat"),
        createLoc("Tușinu", "sat")
    ]),
    ...
    createComuna("Suplac", [
        ...
        createLoc("Laslău Mic", "sat"),
        createLoc("Vaidacuta", "sat")
    ]),
    ...
    createComuna("Valea Largă", [
        ...
        createLoc("Valea Frăției", "sat"),
        createLoc("Valea Glodului", "sat"),
        createLoc("Valea Pădurii", "sat"),
        createLoc("Valea Șurii", "sat"),
        createLoc("Valea Urieșului", "sat")
    ]),
    ...
    createComuna("Zau de Câmpie", [
        ...
        createLoc("Botei", "sat"),
        createLoc("Bujor-Hodaie", "sat"),
        createLoc("Ciretea", "sat"),
        createLoc("Gaura Sângerului", "sat"),
        createLoc("Malea", "sat"),
        createLoc("Ștefăneaca", "sat"),
        createLoc("Tău", "sat")
    ]),						  
