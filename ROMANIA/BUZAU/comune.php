...
$comune =[
    ...
    createComuna("Beceni", [
        ...
        createLoc("Gura Dimienii", "sat"),
        createLoc("Izvoru Dulce", "sat"),
        createLoc("Mărgăriți", "sat"),
    ...
    createComuna("Berca", [
        ...
        createLoc("Mânăstirea Rătești", "sat"),
        createLoc("Pâclele", "sat"),
        createLoc("Pleșcoi", "sat"),
        createLoc("Pleșești", "sat"),
        createLoc("Rătești", "sat"),
        createLoc("Sătuc", "sat"),
        createLoc("Tâțârligu", "sat"),
        createLoc("Valea Nucului", "sat"),
    ...
    createComuna("Bisoca", [
        ...
        createLoc("Lopătăreasa", "sat"),
        createLoc("Pleși", "sat"),
        createLoc("Recea", "sat"),
        createLoc("Sările", "sat"),
    ...
    createComuna("Brăești", [
        ...
        createLoc("Ivănețu", "sat"),
        createLoc("Pinu", "sat"),
        createLoc("Pârscovelu", "sat"),
    ...
    createComuna("Breaza", [
        ...
        createLoc("Văleanca-Vilănești", "sat"),
    ...
    createComuna("Buda", [
        ...
        createLoc("Mucești-Dănulești", "sat"),
        createLoc("Spidele", "sat"),
        createLoc("Toropălești", "sat"),
    ...
    createComuna("Cănești", [
        ...
        createLoc("Păcurile", "sat"),
        createLoc("Șuchea", "sat"),
    ...
    createComuna("Chiliile", [
        ...
        createLoc("Ghiocari", "sat"),
        createLoc("Glodu-Petcari", "sat"),
        createLoc("Poiana Pletari", "sat"),
    ...
    createComuna("Cozieni", [
        ...
        createLoc("Bercești", "sat"),
        createLoc("Ciocănești", "sat"),
        createLoc("Cocârceni", "sat"),
        createLoc("Colțeni", "sat"),
        createLoc("Fața lui Nan", "sat"),
        createLoc("Glodurile", "sat"),
        createLoc("Izvoru", "sat"),
        createLoc("Lungești", "sat"),
        createLoc("Nistorești", "sat"),
        createLoc("Pietraru", "sat"),
        createLoc("Punga", "sat"),
        createLoc("Teișu", "sat"),
        createLoc("Trestia", "sat"),
        createLoc("Tulburea", "sat"),
        createLoc("Valea Banului", "sat"),
        createLoc("Valea Roatei", "sat"),
    ...
    createComuna("Gura Teghii", [
        ...
        createLoc("Secuiu", "sat"),
        createLoc("Vadu Oii", "sat"),
    ...
    createComuna("Lopătari", [
        ...
        createLoc("Luncile", "sat"),
        createLoc("Pestrițu", "sat"),
        createLoc("Plaiu Nucului", "sat"),
        createLoc("Ploștina", "sat"),
        createLoc("Potecu", "sat"),
        createLoc("Săreni", "sat"),
        createLoc("Terca", "sat"),
    ...
    createComuna("Merei", [
        ...
        createLoc("Dobrilești", "sat"),
        createLoc("Gura Sărății", "sat"),
        createLoc("Izvoru Dulce", "sat"),
        createLoc("Lipia", "sat"),
        createLoc("Nenciulești", "sat"),
        createLoc("Ogrăzile", "sat"),
        createLoc("Sărata-Monteoru", "sat"),
    ...
    createComuna("Mânzălești", [
        ...
        createLoc("Ghizdita", "sat"),
        createLoc("Gura Bădicului", "sat"),
        createLoc("Jghiab", "sat"),
        createLoc("Plavățu", "sat"),
        createLoc("Poiana Vâlcului", "sat"),
        createLoc("Satu Vechi", "sat"),
        createLoc("Trestioora", "sat"),
        createLoc("Valea Cotoarei", "sat"),
    ...
    createComuna("Odăile", [
        ...
        createLoc("Gorâni", "sat"),
        createLoc("Lacu", "sat"),
        createLoc("Piatra Albă", "sat"),
        createLoc("Posobești", "sat"),
        createLoc("Scoroșești", "sat"),
        createLoc("Valea Fântânei", "sat"),
    ...
    createComuna("Pănătău", [
        ...
        createLoc("Măguricea", "sat"),
        createLoc("Plăișor", "sat"),
        createLoc("Râpile", "sat"),
        createLoc("Sibiciu de Jos", "sat"),
        createLoc("Tega", "sat"),
    ...
    createComuna("Pârscov", [
        ...
        createLoc("Lunca Frumoasă", "sat"),
        createLoc("Oleșești", "sat"),
        createLoc("Pârjolești", "sat"),
        createLoc("Robești", "sat"),
        createLoc("Runcu", "sat"),
        createLoc("Târcov", "sat"),
        createLoc("Tocileni", "sat"),
        createLoc("Trestieni", "sat"),
    ...
    createComuna("Sărulești", [
        ...
        createLoc("Goicelu", "sat"),
        createLoc("Sările-Cătun", "sat"),
        createLoc("Valea Largă-Sărulești", "sat"),
    ...
    createComuna("Scorțoasa", [
        ...
        createLoc("Dâlma", "sat"),
        createLoc("Golu Grabicina", "sat"),
        createLoc("Grabicina de Jos", "sat"),
        createLoc("Grabicina de Sus", "sat"),
        createLoc("Gura Văii", "sat"),
        createLoc("Plopeasa", "sat"),
    ...
    createComuna("Smeeni", [
        ...
        createLoc("Călțuna", "sat"),
        createLoc("Moisica", "sat"),
        createLoc("Udați-Lucieni", "sat"),
    ...
    createComuna("Tisău", [
        ...
        createLoc("Haleș", "sat"),
        createLoc("Izvoranu", "sat"),
        createLoc("Leiculești", "sat"),
        createLoc("Pădurenii", "sat"),
        createLoc("Salcia", "sat"),
        createLoc("Strezeni", "sat"),
        createLoc("Tisău", "sat"),
    ...
    createComuna("Vernești", [
        ...
        createLoc("Nenciu", "sat"),
        createLoc("Nișcov", "sat"),
        createLoc("Săsenii Noi", "sat"),
        createLoc("Săsenii pe Vale", "sat"),
        createLoc("Săsenii Vechi", "sat"),
    ...
    createComuna("Vintilă Vodă", [
        ...
        createLoc("Coca-Niculești", "sat"),
        createLoc("Niculești", "sat"),
        createLoc("Petrăchești", "sat"),
        createLoc("Podu Muncii", "sat"),
    ...
    createComuna("Viperești", [
        ...
        createLoc("Rușavăț", "sat"),
        createLoc("Tronari", "sat"),
    ...
    createComuna("Ziduri", [
        ...
        createLoc("Heliade Rădulescu", "sat"),
