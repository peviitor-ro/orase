...
$comune =[
    ...
    createComuna("Avrămeni", [
        ...
        createLoc("Ichimeni", "sat"),
        createLoc("Panaitoaia", "sat"),
        createLoc("Timuș", "sat"),
        createLoc("Tudor Vladimirescu", "sat")
    ]),
    createComuna("Bălușeni", [
        ...
        createLoc("Coșuleni", "sat"),
        createLoc("Draxini", "sat"),
    ...
    createComuna("Coțușca", [
        ...
        createLoc("Crasnaleuca", "sat"),
        createLoc("Ghireni", "sat"),
        createLoc("Mihail Kogălniceanu", "sat"),
        createLoc("Nichiteni", "sat"),
    ...
    createComuna("Curtești", [
        ...
        createLoc("Hudum", "sat"),
        createLoc("Mănăstirea Doamnei", "sat"),
        createLoc("Orășeni-Deal", "sat"),
    ...
    createComuna("Gorbănești", [
        ...
        createLoc("Mihai Eminescu", "sat"),
        createLoc("Silișcani", "sat"),
        createLoc("Socrujeni", "sat"),
    ...
    createComuna("Havârna", [
        ...
        createLoc("Gârbeni", "sat"),
        createLoc("Niculcea", "sat"),
    ...
    createComuna("Manoleasa", [
        ...
        createLoc("Iorga", "sat"),
        createLoc("Liveni", "sat"),
        createLoc("Loturi", "sat"),
        createLoc("Manoleasa-Prut", "sat"),
        createLoc("Sadoveni", "sat"),
        createLoc("Șerpenița", "sat"),
    ...
    createComuna("Mihai Eminescu", [
        ...
        createLoc("Cătămărești-Deal", "sat"),
        createLoc("Cervicești", "sat"),
        createLoc("Cervicești-Deal", "sat"),
        createLoc("Cucorăni", "sat"),
        createLoc("Manolești", "sat"),
    ...
    createComuna("Ripiceni", [
        ...
        createLoc("Movila Ruptă", "sat"),
        createLoc("Popoaia", "sat"),
        createLoc("Ripicenii Vechi", "sat"),
        createLoc("Râșca", "sat")
    ]),
    createComuna("Roma", [
        createAdresaCompleta("BOTOSANI", "BOTOSANI"),
    ...
    createComuna("Santa Mare", [
        ...
        createLoc("Durnești", "sat"),
        createLoc("Ilișeni", "sat"),
        createLoc("Rânghilești", "sat"),
    ...
    createComuna("Ungureni", [
        ...
        createLoc("Călugărenii Noi", "sat"),
        createLoc("Durnești", "sat"),
        createLoc("Mihai Viteazu", "sat"),
        createLoc("Mândrești", "sat"),
        createLoc("Plopenii Mari", "sat"),
        createLoc("Plopenii Mici", "sat"),
    ...
    createComuna("Unțeni", [
        ...
        createLoc("Mânăstireni", "sat"),
        createLoc("Soroceni", "sat"),
        createLoc("Valea Grajdului", "sat"),
    ...
    createComuna("Vârfu Câmpului", [
        ...
        createLoc("Ionășeni", "sat"),
        createLoc("Maghera", "sat"),
        createLoc("Pustoaia", "sat"),
        createLoc("Lunca", "sat")
    ]),
    ...
    createComuna("Vorona", [
        ...
        createLoc("Poiana", "sat"),
        createLoc("Vorona Mare", "sat"),
        createLoc("Vorona-Teodoru", "sat")
    ]),
