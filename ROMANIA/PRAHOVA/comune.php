...
$comune = [
    ...
    createComuna("Apostolache", [
        ...
        createLoc("Valea Cricovului", "sat")
    ]),
    ...
    createComuna("Ceptura", [
        ...
        createLoc("Rotari", "sat"),
        createLoc("Șoimești", "sat")
    ]),
    ...
    createComuna("Cerașu", [
        ...
        createLoc("Valea Brădetului", "sat"),
        createLoc("Valea Lespezii", "sat"),
        createLoc("Valea Tocii", "sat")
    ]),
    ...
    createComuna("Cocorăștii Colț", [
        ...
        createLoc("Colțu de Jos", "sat"),
        createLoc("Ghioldum", "sat"),
        createLoc("Perșunari", "sat"),
        createLoc("Piatra", "sat"),
        createLoc("Satu de Sus", "sat")
    ]),
    ...
    createComuna("Drajna", [
        ...
        createLoc("Drajna de Jos", "sat"),
        createLoc("Făget", "sat"),
        createLoc("Ogretin", "sat"),
        createLoc("Piatra", "sat"),
        createLoc("Pițigoi", "sat"),
        createLoc("Plai", "sat"),
        createLoc("Podurile", "sat"),
        createLoc("Poiana Mierlei", "sat")
    ]),
    ...
    createComuna("Drăgănești", [
        ...
        createLoc("Cornu de Jos", "sat"),
        createLoc("Hătcărău", "sat"),
        createLoc("Meri", "sat"),
        createLoc("Tufani", "sat")
    ]),
    ...
    createComuna("Dumbrava", [
        ...
        createLoc("Cornu de Sus", "sat"),
        createLoc("Trestienii de Jos", "sat"),
        createLoc("Trestienii de Sus", "sat"),
    ...
    createComuna("Dumbrăvești", [
        ...
        createLoc("Mălăeștii de Sus", "sat"),
        createLoc("Plopeni", "sat"),
        createLoc("Sfârleanca", "sat")
    ]),
    ...
    createComuna("Filipeștii de Pădure", [
        ...
        createLoc("Siliștea Dealului", "sat")
    ]),
    ...
    createComuna("Filipeștii de Târg", [
        ...
        createLoc("Ezeni", "sat"),
        createLoc("Mărginenii de Jos", "sat"),
    ...
    createComuna("Gorgota", [
        ...
        createLoc("Poienarii Apostoli", "sat"),
        createLoc("Potigrafu", "sat")
    ]),
    ...
    createComuna("Iordăcheanu", [
        ...
        createLoc("Străoști", "sat"),
        createLoc("Valea Cucului", "sat"),
        createLoc("Vărbila", "sat")
    ]),
    ...
    createComuna("Izvoarele", [
        ...
        createLoc("Homorâciu", "sat"),
        createLoc("Malu Vânăt", "sat"),
        createLoc("Schiulești", "sat")
    ]),
    ...
    createComuna("Măneciu", [
        ...
        createLoc("Făcăieni", "sat"),
        createLoc("Gheaba", "sat"),
        createLoc("Măneciu-Pământeni", "sat"),
        createLoc("Mânăstirea Suzana", "sat"),
        createLoc("Plăiețu", "sat")
    ]),
    ...
    createComuna("Mănești", [
        ...
        createLoc("Gura Crivățului", "sat"),
        createLoc("Zalhanaua", "sat")
    ]),
    ...
    createComuna("Podenii Noi", [
        ...
        createLoc("Nevesteasca", "sat"),
        createLoc("Podu lui Galben", "sat"),
        createLoc("Popești", "sat"),
        createLoc("Rahova", "sat"),
        createLoc("Sălcioara", "sat"),
        createLoc("Sfăcăru", "sat"),
        createLoc("Valea Dulce", "sat")
    ]),
    ...
    createComuna("Poienarii Burchii", [
        ...
        createLoc("Piorești", "sat"),
        createLoc("Podu Văleni", "sat"),
        createLoc("Poienarii-Rali", "sat"),
        createLoc("Poienarii Vechi", "sat"),
        createLoc("Tătărăi", "sat")
    ]),
    ...
    createComuna("Posești", [
        ...
        createLoc("Nucșoara de Jos", "sat"),
        createLoc("Nucșoara de Sus", "sat"),
    ...
    createComuna("Predeal-Sărari", [
        ...
        createLoc("Sărari", "sat"),
        createLoc("Sărățel", "sat"),
        createLoc("Tulburea", "sat"),
        createLoc("Tulburea-Văleni", "sat"),
        createLoc("Vitioara de Sus", "sat"),
        createLoc("Zâmbroaia", "sat")
    ]),
    ...
    createComuna("Puchenii Mari", [
        ...
        createLoc("Puchenii Mici", "sat"),
        createLoc("Puchenii-Moșneni", "sat")
    ]),
    ...
    createComuna("Sângeru", [
        ...
        createLoc("Mireșu Mic", "sat"),
        createLoc("Piatra Mică", "sat"),
        createLoc("Tisa", "sat")
    ]),
    ...
    createComuna("Starchiojd", [
        ...
        createLoc("Rotarea", "sat"),
        createLoc("Valea Anei", "sat"),
        createLoc("Zmeuret", "sat")
    ]),
    ...
    createComuna("Șotrile", [
        ...
        createLoc("Plaiu Cornului", "sat"),
        createLoc("Seciuri", "sat"),
        createLoc("Vistieru", "sat")
    ]),
    ...
    createComuna("Teișani", [
        ...
        createLoc("Ștubeiu", "sat"),
        createLoc("Valea Stâlpului", "sat")
    ]),
    ...
    createComuna("Telega", [
        ...
        createLoc("Doftana", "sat"),
        createLoc("Melicești", "sat"),
        createLoc("Țonțești", "sat")
    ]),
    ...
    createComuna("Valea Călugărească", [
        ...
        createLoc("Pantazi", "sat"),
        createLoc("Rachieri", "sat"),
        createLoc("Radila", "sat"),
        createLoc("Schiau", "sat"),
        createLoc("Valea Largă", "sat"),
        createLoc("Valea Mantei", "sat"),
        createLoc("Valea Nicovani", "sat"),
        createLoc("Valea Poienii", "sat"),
        createLoc("Valea Popii", "sat"),
        createLoc("Valea Ursoii", "sat"),
    ...
    createComuna("Vărbilău", [
        ...
        createLoc("Podu Ursului", "sat"),
        createLoc("Poiana Vărbilău", "sat")
    ]),
