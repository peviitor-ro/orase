...
$orase=[
	createOras("FIENI", [
		createLoc("FIENI", "oras", [
			createLoc("Berevoești", "sat", createAdresaCompleta("sat Berevoești, orasul FIENI, judetul DÂMBOVIȚA, România")),
			createLoc("Costești", "sat", createAdresaCompleta("sat Costești, orasul FIENI, judetul DÂMBOVIȚA, România")),
		], createAdresaCompleta("orasul FIENI, judetul DÂMBOVIȚA, România")),
	], createAdresaCompleta("orasul FIENI, judetul DÂMBOVIȚA, România")),
	createOras("GĂEȘTI", [
	...
	createOras("TITU", [
		createLoc("TITU", "oras", [
			createLoc("Fusea", "sat", createAdresaCompleta("sat Fusea, orasul TITU, judetul DÂMBOVIȚA, România")),
			createLoc("Hagioaica", "sat", createAdresaCompleta("sat Hagioaica, orasul TITU, judetul DÂMBOVIȚA, România")),
			createLoc("Mereni", "sat", createAdresaCompleta("sat Mereni, orasul TITU, judetul DÂMBOVIȚA, România")),
			createLoc("Plopu", "sat", createAdresaCompleta("sat Plopu, orasul TITU, judetul DÂMBOVIȚA, România")),
			createLoc("Sălcuța", "sat", createAdresaCompleta("sat Sălcuța, orasul TITU, judetul DÂMBOVIȚA, România")),
