...
[
	 createMunicipiu("TÂRGOVIȘTE", [
		...
		], createAdresaCompleta("orasul TÂRGOVIȘTE, municipiul TÂRGOVIȘTE, judetul DÂMBOVIȚA, România", "orasul TARGOVISTE, municipiul TARGOVISTE, judetul DAMBOVITA, Romania")),
	 ...
	 createMunicipiu("MORENI", [
		createLoc("MORENI", "oras", createAdresaCompleta("orasul MORENI, municipiul MORENI, judetul DÂMBOVIȚA, România", "orasul MORENI, municipiul MORENI, judetul DAMBOVITA, Romania")),
