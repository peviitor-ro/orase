...
$comune =[
    ...
    createComuna("Chiochiș", [
        ...
        createLoc("Buza Cătun", "sat"),
        createLoc("Chețiu", "sat"),
        createLoc("Jimbor", "sat"),
        createLoc("Manic", "sat"),
        createLoc("Sânnicoară", "sat"),
        createLoc("Strugureni", "sat"),
    ...
    createComuna("Milaș", [
        ...
        createLoc("Ghemeș", "sat"),
        createLoc("Hirean", "sat"),
    ...
    createComuna("Nimigea", [
        ...
        createLoc("Mititei", "sat"),
        createLoc("Mocod", "sat"),
        createLoc("Mogoșeni", "sat"),
        createLoc("Nimigea de Sus", "sat"),
        createLoc("Tăure", "sat")
    ]),
    createComuna("Nușeni", [
        createAdresaCompleta("BISTRITA-NASAUD"),
        ...
        createLoc("Dumbrava", "sat"),
        createLoc("Feleac", "sat"),
        createLoc("Malin", "sat"),
        createLoc("Rusu de Sus", "sat"),
        createLoc("Vița", "sat")
    ]),
    createComuna("Parva", [
        createAdresaCompleta("BISTRITA-NASAUD"),
    ...
    createComuna("Spermezeu", [
        ...
        createLoc("Hălmăsău", "sat"),
        createLoc("Lunca Borlesei", "sat"),
        createLoc("Păltineasa", "sat"),
        createLoc("Sita", "sat"),
    ...
    createComuna("Șieu-Măgheruș", [
        ...
        createLoc("Crainimăt", "sat"),
        createLoc("Podirei", "sat"),
    ...
    createComuna("Șieu-Odorhei", [
        ...
        createLoc("Bretea", "sat"),
        createLoc("Coasta", "sat"),
        createLoc("Cristur-Șieu", "sat"),
    ...
    createComuna("Teaca", [
        ...
        createLoc("Ocnița", "sat"),
        createLoc("Pinticu", "sat"),
    ...
    createComuna("Tiha Bârgăului", [
        ...
        createLoc("Piatra Fântânele", "sat"),
    ...
    createComuna("Târlișua", [
        ...
        createLoc("Borleasa", "sat"),
        createLoc("Cireași", "sat"),
        createLoc("Lunca Sătească", "sat"),
        createLoc("Molișet", "sat"),
        createLoc("Oarzina", "sat"),
        createLoc("Răcăteșu", "sat"),
    ...
    createComuna("Urmeniș", [
        ...
        createLoc("Podenii", "sat"),
        createLoc("Scoabe", "sat"),
        createLoc("Șopteriu", "sat"),
        createLoc("Valea", "sat"),
        createLoc("Valea Mare", "sat")
    ]),
    createComuna("Zagra", [
        ...
        createLoc("Poienile Zagrei", "sat"),
        createLoc("Suplai", "sat")
    ]),
