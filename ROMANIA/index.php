...
require_once "BISTRITA-NASAUD/bistritanasaud.php";
...
require_once "CARAS-SEVERIN/carasseverin.php";
...
require_once "SUCEAVA/suceava.php";
require_once "TELEORMAN/teleorman.php";
require_once "TIMIS/timis.php";
require_once "TULCEA/tulcea.php";
require_once "VASLUI/vaslui.php";
require_once "VALCEA/valcea.php";
require_once "VRANCEA/vrancea.php";
