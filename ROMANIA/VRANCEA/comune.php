...
$comune =[
	...
	createComuna("Andreiașu de Jos", [
        ...
        createLoc("Răchitașu", "sat"),
        createLoc("Titila", "sat")
    ]),
    ...
    createComuna("Boghești", [
        ...
        createLoc("Plăcințeni", "sat"),
        createLoc("Pleșești", "sat"),
        createLoc("Prisecani", "sat"),
        createLoc("Tăbucești", "sat")
    ]),
    ...
    createComuna("Bolotești", [
        ...
        createLoc("Putna", "sat"),
        createLoc("Vităneștii de sub Măgură", "sat")
    ]),
    ...
    createComuna("Ciorăști", [
        ...
        createLoc("Salcia Nouă", "sat"),
        createLoc("Salcia Veche", "sat"),
    ...
    createComuna("Câmpuri", [
        ...
        createLoc("Rotileștii Mari", "sat"),
        createLoc("Rotileștii Mici", "sat")
    ]),
    ...
    createComuna("Corbița", [
        ...
        createLoc("Largășeni", "sat"),
        createLoc("Ocheșești", "sat"),
    ...
    createComuna("Dumitrești", [
        ...
        createLoc("Blidari", "sat"),
        createLoc("Dumitreștii de Sus", "sat"),
        createLoc("Dumitreștii-Față", "sat"),
        createLoc("Găloiești", "sat"),
        createLoc("Lăstuni", "sat"),
        createLoc("Lupoaia", "sat"),
        createLoc("Motnău", "sat"),
        createLoc("Poienița", "sat"),
        createLoc("Roșcari", "sat"),
        createLoc("Siminoc", "sat"),
        createLoc("Tinoasa", "sat"),
    ...
    createComuna("Garoafa", [
        ...
        createLoc("Precistanu", "sat"),
        createLoc("Răchitosu", "sat"),
        createLoc("Străjescu", "sat")
    ]),
    ...
    createComuna("Gura Caliței", [
        ...
        createLoc("Dealu Lung", "sat"),
        createLoc("Groapa Tufei", "sat"),
        createLoc("Lacu lui Baban", "sat"),
        createLoc("Plopu", "sat"),
        createLoc("Poenile", "sat"),
        createLoc("Rașca", "sat"),
        createLoc("Șotârcari", "sat")
    ]),
    ...
    createComuna("Măicănești", [
        ...
        createLoc("Slobozia Botești", "sat"),
        createLoc("Stupina", "sat"),
    ...
    createComuna("Mera", [
        ...
        createLoc("Roșioara", "sat"),
        createLoc("Vulcăneasa", "sat")
    ]),
    ...
    createComuna("Nereju", [
        ...
        createLoc("Nereju Mic", "sat"),
        createLoc("Sahastru", "sat")
    ]),
    ...
    createComuna("Nistorești", [
        ...
        createLoc("Podu Șchiopului", "sat"),
        createLoc("Românești", "sat"),
        createLoc("Ungureni", "sat"),
        createLoc("Valea Neagră", "sat"),
        createLoc("Vetrești-Herăstrău", "sat")
    ]),
    ...
    createComuna("Poiana Cristei", [
        ...
        createLoc("Mahriu", "sat"),
        createLoc("Odobasca", "sat"),
        createLoc("Petreanu", "sat"),
        createLoc("Podu Lacului", "sat"),
        createLoc("Târâtu", "sat")
    ]),
    ...
    createComuna("Reghiu", [
        ...
        createLoc("Piscu Reghiului", "sat"),
        createLoc("Răiuți", "sat"),
        createLoc("Șindrilari", "sat"),
        createLoc("Ursoaia", "sat"),
        createLoc("Valea Milcovului", "sat")
    ]),
    ...
    createComuna("Slobozia Bradului", [
        ...
        createLoc("Olăreni", "sat"),
        createLoc("Valea Beciului", "sat")
    ]),
    ...
    createComuna("Spulber", [
        ...
        createLoc("Păvălari", "sat"),
        createLoc("Tojanii de Jos", "sat"),
        createLoc("Tojanii de Sus", "sat"),
        createLoc("Țipău", "sat")
    ]),
    ...
    createComuna("Tănăsoaia", [
        ...
        createLoc("Costișa", "sat"),
        createLoc("Costișa de Sus", "sat"),
        createLoc("Covrag", "sat"),
        createLoc("Feldioara", "sat"),
        createLoc("Galbeni", "sat"),
        createLoc("Nănești", "sat"),
        createLoc("Vladnicu de Jos", "sat"),
        createLoc("Vladnicu de Sus", "sat")
    ]),
    ...
    createComuna("Vidra", [
        ...
        createLoc("Ruget", "sat"),
        createLoc("Scafari", "sat"),
        createLoc("Șerbești", "sat"),
        createLoc("Tichiriș", "sat"),
        createLoc("Viișoara", "sat"),
        createLoc("Voloșcani", "sat")
    ]),
    ...
    createComuna("Vintileasca", [
        ...
        createLoc("Neculele", "sat"),
        createLoc("Poiana Stoichii", "sat"),
        createLoc("Tănăsari", "sat")
    ]),
    ...
    createComuna("Vizantea-Livezi", [
        ...
        createLoc("Vizantea Mănăstirească", "sat"),
        createLoc("Vizantea Răzășească", "sat")
    ]),
    ...
    createComuna("Vânători", [
        ...
        createLoc("Mirceștii Noi", "sat"),
        createLoc("Mirceștii Vechi", "sat"),
    ...
    createComuna("Vulturu", [
        ...
        createLoc("Maluri", "sat"),
        createLoc("Vadu Roșca", "sat")
    ]),								  
